              ...
              const convertImgDataToPng = function() {
                ...
                function deflateSync(literals) {
                  ...
                  try {
                    ...
                    const output = (init_zlib(), __toCommonJS(zlib_exports)).deflateSync(input, {
                      level: 9
                    });
...
`;
          ...
          (__unused_webpack_module2, exports2, __w_pdfjs_require__2) => {
            ...
            ;
            const fs = (init_fs(), __toCommonJS(fs_exports));
            const http = (init_http(), __toCommonJS(http_exports));
            const https = (init_https(), __toCommonJS(https_exports));
            const url = (init_url(), __toCommonJS(url_exports));
...
// dep:svelte-pdf__pdfjs-dist
var svelte_pdf_pdfjs_dist_default = require_pdf();
export {
  svelte_pdf_pdfjs_dist_default as default
};
//# sourceMappingURL=svelte-pdf__pdfjs-dist.js.map
